...
public class WaterAbilities : MonoBehaviour
{
    ...
    // --- UI ---
    private CooldownUI waterLaserIconUI;
    private CooldownUI waterClonIconUI;
    ...
    private void Start()
    {
        ...
        {
            waterLaserIconUI = AbilityHUD.Instance.waterLaserIcon;
            waterClonIconUI  = AbilityHUD.Instance.waterClonIcon;
        }
    }
    ...
    private void Update()
    {
        ...
        if (isUsingLaser) HandleLaserRotation();
    }
    ...
    private void StartChargingLaser()
    {
        ...
        // Oscurecer mientras carga y está activo
        waterLaserIconUI?.SetUnavailable();
    ...
    private void StopLaser()
    {
        ...
        if (currentLaser != null) currentLaser.SetActive(false);

        waterLaserIconUI?.SetAvailable();
    }
    ...
    private void OnAbility2Destroyed()
    {
        ...
        waterClonIconUI?.SetOnCooldown(cooldown);
