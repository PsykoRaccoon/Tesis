...
public class LOLCamera : MonoBehaviour
{
    ...
    public Vector2 moveLimits = new Vector2(50, 50); // l�mite del movimiento en X/Z

    [Header("Zoom")]
    public float scrollSpeed = 200f; // velocidad de zoom
    public float minY = 20f; // altura m�nima
    public float maxY = 60f; // altura m�xima
